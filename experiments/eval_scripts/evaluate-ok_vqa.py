...
def eval(ans_file, label_file, path, output_file):
    ...
    for item in tqdm(labels):
        labels_dict[item["question_id"]]=item["answers"]
    ...
    for answer in answers:
        text = answers_dict[answer["question_id"]][0]
...
def get_args_parser():
    ...
    parser.add_argument("--label_file", type=str, default="../data/ok_vqa/mscoco_val2014_annotations_enhanced.json")
    parser.add_argument("--ans_folder", type=str, default="../gen_scripts/ok_vqa/ib/icd")
