...
if __name__ == '__main__':
    ...
    parser.add_argument("--cap_file", type=str, default='../gen_scripts/chair/ib/icd',
    ...
    parser.add_argument("--coco_path", type=str, default='annotations-2014',
    ...
    args.caption_key = "answer"
    args.image_id_key = "image"
