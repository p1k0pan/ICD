...
def get_args_parser():
    ...
    parser.add_argument("--question_file", type=str, default="../data/text_vqa/TextVQA_0.5.1_val.json")
    parser.add_argument("--save_folder", type=str, default="./text_vqa/ib")
...
def icd(model, vis_processors, txt_processors, data, preprompt, image_root, cd_alpha, cd_beta, format, use_cd=False):
    ...
    with torch.inference_mode():
        for item in tqdm(data):
            ...
            image = os.path.join(image_root,f"{image_id}.jpg" )
...
def main(args):
    ...
    data = json.load(open(args.question_file, "r"))["data"]
